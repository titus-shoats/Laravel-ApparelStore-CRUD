...
<div class="container">
           ...
           <div class="row">
             ...
             <form method="POST" action="/admin/{{$product->product_id}}/" enctype="multipart/form-data">
                     {{ csrf_field() }}
                     {{method_field('PATCH')}}
                        ...
                        @endif
                          <br/>
                           @php
                             $product_price_format = number_format($product->product_price,2);
                          @endphp

                          <input  class="form-control" type="text" name="product_price" value="{{$product_price_format}}" />
